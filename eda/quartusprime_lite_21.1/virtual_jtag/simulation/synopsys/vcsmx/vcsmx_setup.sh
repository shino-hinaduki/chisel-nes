...
# ACDS 21.1 842 win32 2022.02.06.03:11:58
...
# ----------------------------------------
# If virtual_jtag is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/virtual_jtag.v"                                    
fi
