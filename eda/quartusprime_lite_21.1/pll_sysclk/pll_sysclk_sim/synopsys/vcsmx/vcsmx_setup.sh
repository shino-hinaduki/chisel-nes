...
# ACDS 21.1 842 win32 2022.03.23.03:17:38
...
# ----------------------------------------
# If pll_sysclk is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_sysclk.vo"
fi
