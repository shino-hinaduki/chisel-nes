...
//synthesis_resources = lut 4 M10K 1 reg 37 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
`endif
	...
	always @ ( posedge wrclk or  posedge aclr)
		if (aclr == 1'b1) delayed_wrptr_g <= 3'b0;
