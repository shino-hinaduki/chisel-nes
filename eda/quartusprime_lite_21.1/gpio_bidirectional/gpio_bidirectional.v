...
module  gpio_bidirectional_iobuf_bidir_loo
	( 
	datain,
	dataio,
	dataout,
...
endmodule //gpio_bidirectional_iobuf_bidir_loo
//VALID FILE
...
module gpio_bidirectional (
	...
	gpio_bidirectional_iobuf_bidir_loo	gpio_bidirectional_iobuf_bidir_loo_component (
				.datain (datain),
				.oe (oe),
				.dataio (dataio),
				.dataout (sub_wire0));
