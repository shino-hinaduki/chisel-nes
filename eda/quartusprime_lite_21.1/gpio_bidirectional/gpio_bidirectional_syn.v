...
//altiobuf_bidir DEVICE_FAMILY="Cyclone V" ENABLE_BUS_HOLD="FALSE" NUMBER_OF_CHANNELS=1 OPEN_DRAIN_OUTPUT="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_DYNAMIC_TERMINATION_CONTROL="FALSE" USE_TERMINATION_CONTROL="FALSE" datain dataio dataout oe
...
module  gpio_bidirectional_iobuf_bidir
	( 
	datain,
	dataio,
	dataout,
...
endmodule //gpio_bidirectional_iobuf_bidir
//VALID FILE
...
module gpio_bidirectional (
	...
	gpio_bidirectional_iobuf_bidir	gpio_bidirectional_iobuf_bidir_component (
				.datain (datain),
				.oe (oe),
				.dataio (dataio),
				.dataout (sub_wire0));
