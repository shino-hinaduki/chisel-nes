...
/**
  * dpram_cart_save.v を chiselで取り扱うために用意した定義
  */
class DualPortRamCartSave extends BlackBox with DualPortRam {
  override def desiredName: String = "dpram_cart_save"

  val io = IO(new Bundle {
    val address_a = Input(UInt(13.W))  // input	[12:0]  address_a;
    val address_b = Input(UInt(11.W))  // input	[10:0]  address_b;
