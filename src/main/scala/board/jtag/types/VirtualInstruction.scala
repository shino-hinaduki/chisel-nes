...
object VirtualInstruction {
  ...
  */
  object AccessTarget extends ChiselEnum {
    ...
    val cartCommon   = Value(0x04.U)
    val cartPrg      = Value(0x05.U)
    val cartSave     = Value(0x06.U)
    val cartChr      = Value(0x07.U)
    val frameBuffer  = Value(0x08.U)
    val cpuBusMaster = Value(0x09.U)
    val ppuBusMaster = Value(0x0a.U)
