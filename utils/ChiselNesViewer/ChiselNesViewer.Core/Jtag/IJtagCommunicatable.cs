...
namespace ChiselNesViewer.Core.Jtag {
    ...
    public interface IJtagCommunicatable {
        ...
        /// </summary>
        const uint ReadUnitSize = 63; // 64が最大で、先頭はRD指示に使うので63
        ...
        /// </summary>
        /// <param name="readSize">ReadSize。USB都合で最大ReadUnitSizeまで</param>
        /// <returns>ReadData</returns>
        public byte[] ReadShiftDr(uint readSize = ReadUnitSize);
